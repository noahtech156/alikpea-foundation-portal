...
ALWAYS call `checkClerkManagementStatus` before taking any action. This will indicate if the user's secrets point to Replit-managed Clerk, external Clerk, or have no Clerk setup.
